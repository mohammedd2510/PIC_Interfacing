...
# 11 "MCAL_Layer/Timer2/../Interrupt/../std_libraries.h"
...
# 11 "MCAL_Layer/Timer2/../Interrupt/../std_libraries.h" 2
...
# 1 "MCAL_Layer/Timer2/../Interrupt/../my_pic18f4620.h" 1
# 101 "MCAL_Layer/Timer2/../Interrupt/../my_pic18f4620.h"
typedef union {
  struct {
   uint8 RBIF :1;
   uint8 INT0IF :1;
...
# 257 "MCAL_Layer/Timer2/../Interrupt/../my_pic18f4620.h"
typedef struct {
  uint8 RD :1;
  uint8 WR :1;
  uint8 WREN :1;
...
# 362 "MCAL_Layer/Timer2/../Interrupt/../my_pic18f4620.h"
typedef union {
  struct {
   uint8 TMR1ON :1;
   uint8 TMR1CS :1;
...
# 387 "MCAL_Layer/Timer2/../Interrupt/../my_pic18f4620.h"
typedef union {
  struct {
   uint8 T2CKPS0 :1;
   uint8 T2CKPS1 :1;
...
# 12 "MCAL_Layer/Timer2/../Interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL_Layer/Timer2/../Interrupt/../GPIO/../device_config.h" 1
# 12 "MCAL_Layer/Timer2/../Interrupt/../GPIO/hal_gpio.h" 2


# 1 "MCAL_Layer/Timer2/../Interrupt/../GPIO/hal_gpio_cfg.h" 1
# 14 "MCAL_Layer/Timer2/../Interrupt/../GPIO/hal_gpio.h" 2
# 31 "MCAL_Layer/Timer2/../Interrupt/../GPIO/hal_gpio.h"
typedef enum{
    LOW=0,
    HIGH
}logic_t;
...
# 59 "MCAL_Layer/Timer2/../Interrupt/mcal_interrupt_config.h"
typedef enum {
...
# 1 "MCAL_Layer/Timer2/../Interrupt/../ADC/hal_adc.h" 1
# 12 "MCAL_Layer/Timer2/../Interrupt/../ADC/hal_adc.h"
# 1 "MCAL_Layer/Timer2/../Interrupt/../ADC/hal_adc_cfg.h" 1
# 12 "MCAL_Layer/Timer2/../Interrupt/../ADC/hal_adc.h" 2




# 1 "MCAL_Layer/Timer2/../Interrupt/../ADC/../Interrupt/mcal_internal_interrupt.h" 1
# 16 "MCAL_Layer/Timer2/../Interrupt/../ADC/hal_adc.h" 2
# 100 "MCAL_Layer/Timer2/../Interrupt/../ADC/hal_adc.h"
...
# 130 "MCAL_Layer/Timer2/../Interrupt/../ADC/hal_adc.h"
typedef enum {
    ADC_0_TAD = 0,
    ADC_2_TAD,
    ADC_4_TAD,
...
InterruptHandler TMR2_InterruptHandler = ((void*)0);
...
Std_ReturnType Timer2_Init(const timer2_t *_timer)
{
    ...
    else
    {
        ...
        ((*((volatile T2CON_t *)(0xFCA))).T2OUTPS = _timer->postscaler_value);
        ...
        ((*((volatile PIE1_t *)(0xF9D))).TMR2IE=1);
        ((*((volatile PIR1_t *)(0xF9E))).TMR2IF=0);
        TMR2_InterruptHandler = _timer->TMR2_InterruptHandler;
            ...
            if(_timer->priority == INTERRUPT_HIGH_PRIORITY){
                ((*((volatile IPR1_t *)(0xF9F))).TMR2IP=1);
...
Std_ReturnType Timer2_DeInit(const timer2_t *_timer)
{
    ...
    else
    {
        ...
        ((*((volatile PIE1_t *)(0xF9D))).TMR2IE=0);
...
Std_ReturnType Timer2_Read_Value(const timer2_t *_timer , uint8 *_value)
{
    ...
    {
        *_value =(*((volatile uint8 *)(0xFCC)));
    }
    return ret;
}

void TMR2_ISR(void){
    (*((volatile uint8 *)(0xFCC))) = timer2_preload;
    ((*((volatile PIR1_t *)(0xF9E))).TMR2IF=0);
