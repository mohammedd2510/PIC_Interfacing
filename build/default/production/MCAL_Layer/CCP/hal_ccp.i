...
# 12 "MCAL_Layer/CCP/../GPIO/hal_gpio.h"
# 1 "MCAL_Layer/CCP/../GPIO/../device_config.h" 1
# 12 "MCAL_Layer/CCP/../GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/CCP/../GPIO/../my_pic18f4620.h" 1
# 101 "MCAL_Layer/CCP/../GPIO/../my_pic18f4620.h"
typedef union {
  struct {
   uint8 RBIF :1;
   uint8 INT0IF :1;
...
# 257 "MCAL_Layer/CCP/../GPIO/../my_pic18f4620.h"
typedef struct {
  uint8 RD :1;
  uint8 WR :1;
  uint8 WREN :1;
...
# 362 "MCAL_Layer/CCP/../GPIO/../my_pic18f4620.h"
typedef union {
  struct {
   uint8 TMR1ON :1;
   uint8 TMR1CS :1;
...
# 387 "MCAL_Layer/CCP/../GPIO/../my_pic18f4620.h"
typedef union {
  struct {
   uint8 T2CKPS0 :1;
   uint8 T2CKPS1 :1;
...
# 485 "MCAL_Layer/CCP/../GPIO/../my_pic18f4620.h"
typedef struct
{
   uint8 TX9D :1;
   uint8 TRMT :1;
...
# 537 "MCAL_Layer/CCP/../GPIO/../my_pic18f4620.h"
typedef struct
{
   uint8 BF :1;
   uint8 UA :1;
...
# 31 "MCAL_Layer/CCP/../GPIO/hal_gpio.h"
typedef enum{
    LOW=0,
    HIGH
}logic_t;
...
# 59 "MCAL_Layer/CCP/../Interrupt/mcal_interrupt_config.h"
typedef enum {
...
# 1 "MCAL_Layer/CCP/../Interrupt/../ADC/hal_adc.h" 1
# 12 "MCAL_Layer/CCP/../Interrupt/../ADC/hal_adc.h"
# 1 "MCAL_Layer/CCP/../Interrupt/../ADC/hal_adc_cfg.h" 1
# 12 "MCAL_Layer/CCP/../Interrupt/../ADC/hal_adc.h" 2




# 1 "MCAL_Layer/CCP/../Interrupt/../ADC/../Interrupt/mcal_internal_interrupt.h" 1
# 16 "MCAL_Layer/CCP/../Interrupt/../ADC/hal_adc.h" 2
# 100 "MCAL_Layer/CCP/../Interrupt/../ADC/hal_adc.h"
...
# 130 "MCAL_Layer/CCP/../Interrupt/../ADC/hal_adc.h"
typedef enum {
    ADC_0_TAD = 0,
    ADC_2_TAD,
    ADC_4_TAD,
...
InterruptHandler CCP1_InterruptHandler = ((void*)0);


static Std_ReturnType CCP2_Interrupt_Init(const ccp_t * _ccp_obj );
InterruptHandler CCP2_InterruptHandler = ((void*)0);
...
Std_ReturnType CCP_Init(const ccp_t * _ccp_obj){
    ...
    else
    {
        ...
        if (_ccp_obj->ccp_inst == CCP1_INST){
            ((*((volatile CCP1CON_t *)(0xFBD))).CCP1M = ((uint8)0x00));
        }
        else if (_ccp_obj->ccp_inst == CCP2_INST){
            ((*((volatile CCP2CON_t *)(0xFBA))).CCP2M = ((uint8)0x00));
        }
...
Std_ReturnType CCP_DeInit(const ccp_t * _ccp_obj)
{
    ...
    else
    {
        ...
        if (_ccp_obj->ccp_inst == CCP1_INST){
            ...
            ((*((volatile PIE1_t *)(0xF9D))).CCP1IE=0);
        ...
        else if (_ccp_obj->ccp_inst == CCP2_INST)
        {
            ...
            ((*((volatile PIE2_t *)(0xFA0))).CCP2IE=0);
...
Std_ReturnType CCP_IsCapturedDataReady (const ccp_t * _ccp_obj, uint8 * _capture_status){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if( (_capture_status==((void*)0)) || (_ccp_obj == ((void*)0)) )
    {
        ret=(Std_ReturnType)0x00;
    }
    else
    {
        if (_ccp_obj->ccp_inst == CCP1_INST)
        {
            if (0x01 == (*((volatile PIR1_t *)(0xF9E))).CCP1IF)
            {
                *_capture_status =0x01;
                ((*((volatile PIR1_t *)(0xF9E))).CCP1IF=0);
            }
            else if (0x00 == (*((volatile PIR1_t *)(0xF9E))).CCP1IF)
            {
        ...
        {
            if (0x01 == (*((volatile PIR2_t *)(0xFA1))).CCP2IF)
            {
                *_capture_status =0x01;
                ((*((volatile PIR2_t *)(0xFA1))).CCP2IF=0);
            }
            else if (0x00 == (*((volatile PIR2_t *)(0xFA1))).CCP2IF)
            {
                *_capture_status =0x00;
            }
            else { ret = (Std_ReturnType)0x00;}
...
{
    Std_ReturnType ret=(Std_ReturnType)0x01;
    CCP_REG_T capture_temp_value = {0};
    if( (capture_value==((void*)0)) || (_ccp_obj == ((void*)0)) )
    {
        ret=(Std_ReturnType)0x00;
    }
    else
    {
        if (_ccp_obj->ccp_inst == CCP1_INST)
        {
           capture_temp_value.ccpr_low = (*( (volatile uint8 *)(0xFBE) ) );
           capture_temp_value.ccpr_high = (*( (volatile uint8 *)(0xFBF) ) );
        }
        else if (_ccp_obj->ccp_inst == CCP2_INST)
        {
           capture_temp_value.ccpr_low = (*( (volatile uint8 *)(0xFBB) ) );
           capture_temp_value.ccpr_high = (*( (volatile uint8 *)(0xFBC) ) );
        }
        else {ret = (Std_ReturnType)0x00;}
...
# 176 "MCAL_Layer/CCP/hal_ccp.c"
Std_ReturnType CCP_IsCompareComplete (const ccp_t * _ccp_obj, uint8 * _compare_status)
{
   Std_ReturnType ret=(Std_ReturnType)0x01;
     if( (_compare_status==((void*)0)) || (_ccp_obj == ((void*)0)) )
    {
        ret=(Std_ReturnType)0x00;
    }
    else
...
{
    Std_ReturnType ret=(Std_ReturnType)0x01;
    CCP_REG_T compare_temp_value = {0};
    if(_ccp_obj==((void*)0))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
    {
        ...
        if (_ccp_obj->ccp_inst == CCP1_INST)
        {
            (*( (volatile uint8 *)(0xFBE) ) ) =compare_temp_value.ccpr_low;
            (*( (volatile uint8 *)(0xFBF) ) ) =compare_temp_value.ccpr_high;
        }
        else if (_ccp_obj->ccp_inst == CCP2_INST)
        {
            (*( (volatile uint8 *)(0xFBB) ) ) =compare_temp_value.ccpr_low;
            (*( (volatile uint8 *)(0xFBC) ) ) =compare_temp_value.ccpr_high;
        }
        else {ret = (Std_ReturnType)0x00;}
    }
    return ret;
}
# 314 "MCAL_Layer/CCP/hal_ccp.c"
static Std_ReturnType CCP_Capture_Mode_Init(const ccp_t * _ccp_obj )
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if (((void*)0) == _ccp_obj)
    ...
    else
    {
        ...
        if (_ccp_obj->ccp_inst == CCP1_INST)
        {
            ...
            {
            case ((uint8)0x04) :
                ((*((volatile CCP1CON_t *)(0xFBD))).CCP1M = ((uint8)0x04));
                break;
            case ((uint8)0x05):
                ((*((volatile CCP1CON_t *)(0xFBD))).CCP1M = ((uint8)0x05));
                break;
            case ((uint8)0x06):
                ((*((volatile CCP1CON_t *)(0xFBD))).CCP1M = ((uint8)0x06));
                break;
            case ((uint8)0x07):
                ((*((volatile CCP1CON_t *)(0xFBD))).CCP1M = ((uint8)0x07));
                break;
            default: ret = (Std_ReturnType)0x00;
            }
        }
        else if (_ccp_obj->ccp_inst == CCP2_INST)
        {
            ...
            {
            case ((uint8)0x04) :
                ((*((volatile CCP2CON_t *)(0xFBA))).CCP2M = ((uint8)0x04));
                break;
            case ((uint8)0x05):
                ((*((volatile CCP2CON_t *)(0xFBA))).CCP2M = ((uint8)0x05));
                break;
            case ((uint8)0x06):
                ((*((volatile CCP2CON_t *)(0xFBA))).CCP2M = ((uint8)0x06));
                break;
            case ((uint8)0x07):
                ((*((volatile CCP2CON_t *)(0xFBA))).CCP2M = ((uint8)0x07));
                break;
            default: ret = (Std_ReturnType)0x00;
            }
        }
...
static Std_ReturnType CCP_Compare_Mode_Init(const ccp_t * _ccp_obj )
{
    ...
    else
    {
        ...
        if (_ccp_obj->ccp_inst == CCP1_INST)
        {
            ...
            {
            case ((uint8)0x02) :
                ((*((volatile CCP1CON_t *)(0xFBD))).CCP1M = ((uint8)0x02));
                break;
            case ((uint8)0x08):
                ((*((volatile CCP1CON_t *)(0xFBD))).CCP1M = ((uint8)0x08));
                break;
            case ((uint8)0x09):
                ((*((volatile CCP1CON_t *)(0xFBD))).CCP1M = ((uint8)0x09));
                break;
            case ((uint8)0x0A):
                ((*((volatile CCP1CON_t *)(0xFBD))).CCP1M = ((uint8)0x0A));
                break;
            case ((uint8)0x0B):
                ((*((volatile CCP1CON_t *)(0xFBD))).CCP1M = ((uint8)0x0B));
                break;
            default: ret = (Std_ReturnType)0x00;
            }
        }
        else if (_ccp_obj->ccp_inst == CCP2_INST)
        {
            ...
            {
            case ((uint8)0x02) :
                ((*((volatile CCP2CON_t *)(0xFBA))).CCP2M = ((uint8)0x02));
                break;
            case ((uint8)0x08):
                ((*((volatile CCP2CON_t *)(0xFBA))).CCP2M = ((uint8)0x08));
                break;
            case ((uint8)0x09):
                ((*((volatile CCP2CON_t *)(0xFBA))).CCP2M = ((uint8)0x09));
                break;
            case ((uint8)0x0A):
                ((*((volatile CCP2CON_t *)(0xFBA))).CCP2M = ((uint8)0x0A));
                break;
            case ((uint8)0x0B):
                ((*((volatile CCP2CON_t *)(0xFBA))).CCP2M = ((uint8)0x0B));
                break;
            default: ret = (Std_ReturnType)0x00;
            }
        }
...
static Std_ReturnType CCP_Capture_Compare_Timer_Config(const ccp_t * _ccp_obj)
{
   Std_ReturnType ret = (Std_ReturnType)0x01;
    ...
    else
    {
        ...
        {
            do{ (*((volatile T3CON_t *)(0xFB1))).T3CCP1 = (uint8)(CCP1_CCP2_TIMER1 & 0x01); (*((volatile T3CON_t *)(0xFB1))).T3CCP2 = (uint8)(CCP1_CCP2_TIMER1 >> 1 ); }while(0);
        }
        else if (_ccp_obj->ccp_capt_comp_timer == CCP1_TIMER1_CCP2_TIMER3)
        {
            do{ (*((volatile T3CON_t *)(0xFB1))).T3CCP1 = (uint8)(CCP1_TIMER1_CCP2_TIMER3 & 0x01); (*((volatile T3CON_t *)(0xFB1))).T3CCP2 = (uint8)(CCP1_TIMER1_CCP2_TIMER3 >> 1 ); }while(0);
        }
        else if (_ccp_obj->ccp_capt_comp_timer == CCP1_CCP2_TIMER3)
        {
            do{ (*((volatile T3CON_t *)(0xFB1))).T3CCP1 = (uint8)(CCP1_CCP2_TIMER3 & 0x01); (*((volatile T3CON_t *)(0xFB1))).T3CCP2 = (uint8)(CCP1_CCP2_TIMER3 >> 1 ); }while(0);
        }
        else {ret = (Std_ReturnType)0x00;}
    }
   return ret;
...
static Std_ReturnType CCP1_Interrupt_Init(const ccp_t * _ccp_obj )
{
    ...
    {
        ((*((volatile PIE1_t *)(0xF9D))).CCP1IE=1);
        ((*((volatile PIR1_t *)(0xF9E))).CCP1IF=0);
...
static Std_ReturnType CCP2_Interrupt_Init(const ccp_t * _ccp_obj )
{
    ...
    {
        ((*((volatile PIE2_t *)(0xFA0))).CCP2IE=1);
        ((*((volatile PIR2_t *)(0xFA1))).CCP2IF=0);
