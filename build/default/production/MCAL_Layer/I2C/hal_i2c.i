...
InterruptHandler I2C_DefaultInterruptHandler = ((void*)0);
InterruptHandler I2C_Report_Write_Collision_InterruptHandler = ((void*)0);
InterruptHandler I2C_Report_Receive_Overflow_InterruptHandler = ((void*)0);
...
Std_ReturnType MSSP_I2C_Init(const mssp_i2c_t *i2c_obj)
{
    ...
    else
    {
        ...
        if(0X01U == i2c_obj->i2c_cfg.i2c_mode)
        {

            I2C_Master_Mode_Clock_Configurations(i2c_obj);
        }
        else if (0X00U == i2c_obj->i2c_cfg.i2c_mode)
        {

            if(0X01U == i2c_obj->i2c_cfg.i2c_general_call)
            {
                ((*((volatile SSPCON2_t *)(0xFC5))).GCEN=0X01U);
            }
            else if(0X00U == i2c_obj->i2c_cfg.i2c_general_call)
            {
                ((*((volatile SSPCON2_t *)(0xFC5))).GCEN=0X00U);
            }
            else{ }

            (*((volatile SSPCON1_t *)(0xFC6))).WCOL =0;

            (*((volatile SSPCON1_t *)(0xFC6))).SSPOV=0;

            (*((volatile SSPCON1_t *)(0xFC6))).CKP=1;


            (*( (volatile uint8 *)(0xFC8) ) ) = i2c_obj->i2c_cfg.i2c_slave_address;
        ...
        if(0X00U == i2c_obj->i2c_cfg.i2c_slew_rate)
        {
            ((*((volatile SSPSTAT_t *)(0xFC7))).SMP=0X00U);
        }
        else if(0X01U == i2c_obj->i2c_cfg.i2c_slew_rate)
        {
            ((*((volatile SSPSTAT_t *)(0xFC7))).SMP=0X01U);
        }
        else{ }

        if(0X01U == i2c_obj->i2c_cfg.i2c_SMBus_control)
        {
            ((*((volatile SSPSTAT_t *)(0xFC7))).CKE=0X01U);
        }
        else if(0X00U == i2c_obj->i2c_cfg.i2c_SMBus_control)
        {
            ((*((volatile SSPSTAT_t *)(0xFC7))).CKE=0X00U);
        }
        else{ }
...
Std_ReturnType MSSP_I2C_Master_Send_Start(const mssp_i2c_t *i2c_obj)
{
    ...
    else
    {
        ...
        (*((volatile SSPCON2_t *)(0xFC5))).SEN = 1;

        while((*((volatile SSPCON2_t *)(0xFC5))).SEN);

        (*((volatile PIR1_t *)(0xF9E))).SSPIF =0;

        if(0X01U == (*((volatile SSPSTAT_t *)(0xFC7))).S){
            ret = (Std_ReturnType)0x01;
        }
        else if(0X00U == (*((volatile SSPSTAT_t *)(0xFC7))).S){
            ret = (Std_ReturnType)0x00;
        }
        else{ }
    }
...
Std_ReturnType MSSP_I2C_Master_Send_Repeated_Start(const mssp_i2c_t *i2c_obj)
{
    ...
    else
    {
        ...
        (*((volatile SSPCON2_t *)(0xFC5))).RSEN = 1;

        while((*((volatile SSPCON2_t *)(0xFC5))).RSEN);
...
Std_ReturnType MSSP_I2C_Master_Send_Stop(const mssp_i2c_t *i2c_obj)
{
    ...
    else
    {
        ...
        (*((volatile SSPCON2_t *)(0xFC5))).PEN = 1;

        while((*((volatile SSPCON2_t *)(0xFC5))).PEN);

        (*((volatile PIR1_t *)(0xF9E))).SSPIF =0;

        if(0X01U == (*((volatile SSPSTAT_t *)(0xFC7))).P){
            ret = (Std_ReturnType)0x01;
        }
        else if(0X00U == (*((volatile SSPSTAT_t *)(0xFC7))).P){
            ret = (Std_ReturnType)0x00;
        }
        else{ }
    }
...
Std_ReturnType MSSP_I2C_Master_Write_Blocking(const mssp_i2c_t *i2c_obj, uint8 i2c_data, uint8 *ack)
{
    ...
    else
    {
        ...
        (*( (volatile uint8 *)(0xFC9) ) ) = i2c_data;

        while(!(*((volatile PIR1_t *)(0xF9E))).SSPIF);

        (*((volatile PIR1_t *)(0xF9E))).SSPIF =0;

        if(0X00U == (*((volatile SSPCON2_t *)(0xFC5))).ACKSTAT)
        {
            *ack =0X00U;
        }
        else if(0X01U == (*((volatile SSPCON2_t *)(0xFC5))).ACKSTAT)
        {
            *ack=0X01U ;
        }
        else{ }
...
Std_ReturnType MSSP_I2C_Master_Read_Blocking(const mssp_i2c_t *i2c_obj, uint8 ack, uint8* i2c_data)
{
    ...
    else
    {
        ...
        ((*((volatile SSPCON2_t *)(0xFC5))).RCEN=0X01U);

        while(!(*((volatile SSPSTAT_t *)(0xFC7))).BF);

        *i2c_data=(*( (volatile uint8 *)(0xFC9) ) );

        if(0X00U == ack)
        {
            (*((volatile SSPCON2_t *)(0xFC5))).ACKDT = 0X00U;

            (*((volatile SSPCON2_t *)(0xFC5))).ACKEN =1;
        }
        else if(0X01U == ack)
        {
           (*((volatile SSPCON2_t *)(0xFC5))).ACKDT = 0X01U;
...
void MSSP_I2C_Clear_Buffer(void){
    uint8 Dummy_Data =0;
    Dummy_Data = (*( (volatile uint8 *)(0xFC9) ) );
}
void MSSP_I2C_Write_To_Buffer(uint8 Data)
{
    (*( (volatile uint8 *)(0xFC9) ) ) = Data;
}
uint8 MSSP_I2C_Read_From_Buffer(void){
    uint8 Temp_Data=0;
    Temp_Data = (*( (volatile uint8 *)(0xFC9) ) );
    return Temp_Data;
}
static __attribute__((inline)) void MSSP_I2C_Mode_GPIO_CFG(void)
{
    (*((volatile uint8*)(0xF94))) |=(1<<3);
    (*((volatile uint8*)(0xF94))) |=(1<<4);
}
static __attribute__((inline)) void I2C_Master_Mode_Clock_Configurations(const mssp_i2c_t *i2c_obj)
{
    (*((volatile SSPCON1_t *)(0xFC6))).SSPM = i2c_obj->i2c_cfg.i2c_mode_cfg;
    (*( (volatile uint8 *)(0xFC8) ) ) =(uint8)(((8000000UL/4.0)/i2c_obj->i2c_clock)-1);
}
static __attribute__((inline)) void I2C_Slave_Mode_Configurations(const mssp_i2c_t *i2c_obj)
{
    (*((volatile SSPCON1_t *)(0xFC6))).SSPM = i2c_obj->i2c_cfg.i2c_mode_cfg;
