...
# 11 "MCAL_Layer/ADC/../GPIO/../std_libraries.h"
...
# 11 "MCAL_Layer/ADC/../GPIO/../std_libraries.h" 2
...
# 11 "MCAL_Layer/ADC/../GPIO/../compiler.h"
...
# 11 "MCAL_Layer/ADC/../GPIO/../compiler.h" 2
...
# 1 "MCAL_Layer/ADC/../GPIO/../my_pic18f4620.h" 1
# 101 "MCAL_Layer/ADC/../GPIO/../my_pic18f4620.h"
typedef union {
  struct {
   uint8 RBIF :1;
   uint8 INT0IF :1;
...
# 257 "MCAL_Layer/ADC/../GPIO/../my_pic18f4620.h"
typedef struct {
  uint8 RD :1;
  uint8 WR :1;
  uint8 WREN :1;
...
# 362 "MCAL_Layer/ADC/../GPIO/../my_pic18f4620.h"
typedef union {
  struct {
   uint8 TMR1ON :1;
   uint8 TMR1CS :1;
...
# 387 "MCAL_Layer/ADC/../GPIO/../my_pic18f4620.h"
typedef union {
  struct {
   uint8 T2CKPS0 :1;
   uint8 T2CKPS1 :1;
...
# 485 "MCAL_Layer/ADC/../GPIO/../my_pic18f4620.h"
typedef struct
{
   uint8 TX9D :1;
   uint8 TRMT :1;
...
# 3 "MCAL_Layer/ADC/hal_adc.c" 2



InterruptHandler ADC_InterruptHandler = ((void*)0);
...
Std_ReturnType ADC_Init(const adc_conf_t *_adc){
    ...
    if(_adc==((void*)0)){
        ...
        ((*((volatile ADCON0_t *)(0xFC2))).ADON=0);

        (*((volatile ADCON2_t *)(0xFC0))).ACQT = _adc->acquisition_time;

        (*((volatile ADCON2_t *)(0xFC0))).ADCS = _adc->conversion_clock;

        (*((volatile ADCON0_t *)(0xFC2))).CHS =_adc->adc_channel;
        ...
        ((*((volatile ADCON0_t *)(0xFC2))).ADON=1);
        }
    return ret;
}
...
Std_ReturnType ADC_SelectChannel(const adc_conf_t *_adc, adc_channel_select_t channel){
    ...
    if(_adc==((void*)0)){
        ret=(Std_ReturnType)0x00;
         ...
         (*((volatile ADCON0_t *)(0xFC2))).CHS =channel;
...
Std_ReturnType ADC_StartConversion(const adc_conf_t *_adc){
    ...
    if(_adc==((void*)0)){
        ...
        ((*((volatile ADCON0_t *)(0xFC2))).GO_DONE=1);
        }
    return ret;
}
...
Std_ReturnType ADC_IsConversionDone(const adc_conf_t *_adc, uint8 *conversion_status){
     ...
     if((_adc==((void*)0))||(conversion_status==((void*)0))){
        ...
        *conversion_status = !(((*((volatile ADCON0_t *)(0xFC2))).GO_DONE));
        }
    return ret;
}
    ...
    Std_ReturnType ret=(Std_ReturnType)0x01;
     if((_adc==((void*)0))||(conversion_result==((void*)0))){
        ...
        switch (_adc->result_format){
            case 0X00U : *conversion_result=(adc_result_t)(((ADRESH<<8) +ADRESL)>>6);break;
            case 0X01U : *conversion_result=(adc_result_t)((ADRESH<<8) +ADRESL);break;
    ...
    Std_ReturnType ret=(Std_ReturnType)0x01;
     if((_adc==((void*)0))||(conversion_result==((void*)0))){
        ret=(Std_ReturnType)0x00;
         ...
         while((*((volatile ADCON0_t *)(0xFC2))).GO_DONE);
...
static __attribute__((inline)) void adc_input_channel_port_configure(adc_channel_select_t channel){
      switch(channel){
          case ADC_CHANNEL_AN0: ((*((volatile uint8*)(0xF92)))|=((uint8)0x01<<0));break;
          case ADC_CHANNEL_AN1: ((*((volatile uint8*)(0xF92)))|=((uint8)0x01<<1));break;
          case ADC_CHANNEL_AN2: ((*((volatile uint8*)(0xF92)))|=((uint8)0x01<<2));break;
          case ADC_CHANNEL_AN3: ((*((volatile uint8*)(0xF92)))|=((uint8)0x01<<3));break;
          case ADC_CHANNEL_AN4: ((*((volatile uint8*)(0xF92)))|=((uint8)0x01<<5));break;
          case ADC_CHANNEL_AN5: ((*((volatile uint8*)(0xF96)))|=((uint8)0x01<<0));break;
          case ADC_CHANNEL_AN6: ((*((volatile uint8*)(0xF96)))|=((uint8)0x01<<1));break;
          case ADC_CHANNEL_AN7: ((*((volatile uint8*)(0xF96)))|=((uint8)0x01<<2));break;
          case ADC_CHANNEL_AN8: ((*((volatile uint8*)(0xF93)))|=((uint8)0x01<<2));break;
          case ADC_CHANNEL_AN9: ((*((volatile uint8*)(0xF93)))|=((uint8)0x01<<3));break;
          case ADC_CHANNEL_AN10: ((*((volatile uint8*)(0xF93)))|=((uint8)0x01<<1));break;
          case ADC_CHANNEL_AN11: ((*((volatile uint8*)(0xF93)))|=((uint8)0x01<<4));break;
          case ADC_CHANNEL_AN12: ((*((volatile uint8*)(0xF93)))|=((uint8)0x01<<0));break;
          default: break;
      }
}
static __attribute__((inline)) void select_result_format(const adc_conf_t *_adc){
    switch (_adc->result_format){
        case 0X00U : ((*((volatile ADCON2_t *)(0xFC0))).ADFM = 0);break;
        case 0X01U : ((*((volatile ADCON2_t *)(0xFC0))).ADFM = 1);break;
        default: ((*((volatile ADCON2_t *)(0xFC0))).ADFM = 1);break;
    }
}
static __attribute__((inline)) void configure_voltage_reference(const adc_conf_t *_adc){
    switch (_adc->voltage_reference){
        case 0X01U : ((*((volatile ADCON1_t *)(0xFC1))).VCFG=3);break;
        case 0X00U: ((*((volatile ADCON1_t *)(0xFC1))).VCFG=0);break;
        default: ((*((volatile ADCON1_t *)(0xFC1))).VCFG=0);break;
    }
}
