...
# 11 "MCAL_Layer/USART/../GPIO/../std_libraries.h"
...
# 11 "MCAL_Layer/USART/../GPIO/../std_libraries.h" 2
...
# 12 "MCAL_Layer/USART/../GPIO/../std_libraries.h" 2
...
# 11 "MCAL_Layer/USART/../GPIO/../compiler.h"
...
# 11 "MCAL_Layer/USART/../GPIO/../compiler.h" 2
...
# 537 "MCAL_Layer/USART/../GPIO/../my_pic18f4620.h"
typedef struct
{
   uint8 BF :1;
   uint8 UA :1;
...
InterruptHandler EUSART_TX_InterruptHandler = ((void*)0);


InterruptHandler EUSART_RX_InterruptHandler = ((void*)0);
InterruptHandler EUSART_FramingErrorHandler = ((void*)0);
InterruptHandler EUSART_OverrunErrorHandler = ((void*)0);
...
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    while(0U==(*((volatile TXSTA_t *)(0xFAC))).TRMT);
    (*( (volatile uint8 *)(0xFAD) ) ) = data;
...
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(1U==(*((volatile TXSTA_t *)(0xFAC))).TRMT)
    {
    (*( (volatile uint8 *)(0xFAD) ) ) = data;
...
Std_ReturnType EUSART_ASYNC_ReadByteBlocking(uint8 *data)
{
    ...
    {
        while (0U==(*((volatile PIR1_t *)(0xF9E))).RCIF );
        *data =(*( (volatile uint8 *)(0xFAE) ) );
    }
    return ret;
}
Std_ReturnType EUSART_ASYNC_ReadByteNonBlocking(uint8 *data){
    ...
    {
        if(1U==(*((volatile PIR1_t *)(0xF9E))).RCIF ){
        *data =(*( (volatile uint8 *)(0xFAE) ) );
        }
        else{ }
    }
...
static void EUSART_Baud_Rate_Calcualtion(const usart_t* _eusart)
{
    ...
    (*( (volatile uint8 *)(0xFAF) ) ) =(uint8)((uint32)Baud_Rate_Temp);
    (*( (volatile uint8 *)(0xFB0) ) ) =(uint8)(((uint32)Baud_Rate_Temp)>>8);
}
...
static void EUSART_ASYNC_RX_Init(const usart_t* _eusart)
{
    if(1 == _eusart->usart_rx_cfg.usart_rx_enable)
    {
        ...
        EUSART_OverrunErrorHandler = _eusart->EUSART_OverrunErrorHandler;
            ...
            ((*((volatile INTCON_t *)(0xFF2))).GIE = 1);
            ((*((volatile INTCON_t *)(0xFF2))).PEIE = 1);
# 276 "MCAL_Layer/USART/hal_usart.c"
